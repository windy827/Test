...
public class MainMenuGridViewAdapter extends BaseAdapter {
	...
	public MainMenuGridViewAdapter(Context context,
			ArrayList<HashMap<String, Object>> al_info) {
		// TODO Auto-generated constructor stub
		this.al_info = al_info;
		this.context = context;
		lf = (LayoutInflater) this.context
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (map.get(position) == null) {
			...
			mv.tv_setname = (TextView) convertView
					.findViewById(R.id.textView_gv_frame1_item1);
		...
		mv.iv_set.setImageResource((Integer) this.al_info.get(position).get(
				"drawable"));
		mv.tv_setname.setText((CharSequence) this.al_info.get(position).get(
				"name"));
		return convertView;
	}
