...
public class MusicLoader {
	...
	//private Uri contentUri = Media.getContentUriForPath("/mnt/sdcard");	
	private Uri contentUri = Media.getContentUriForPath(android.os.Environment.
			getExternalStorageDirectory().getAbsolutePath());	
	//private Uri contentUri = Media.INTERNAL_CONTENT_URI;
				...
				do{
					try {
						...
						if(title.endsWith(".mp3")){
							MusicInfo musicInfo = new MusicInfo(id, title.substring(0, title.length()-4));
