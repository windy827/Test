...
public class NiftyDialogBuilder extends Dialog implements DialogInterface {
    ...
    private void init(Context context) {
        ...
        mButton1=(Button)mDialogView.findViewById(R.id.bt_err1);
        mButton2=(Button)mDialogView.findViewById(R.id.bt_err2);
        mButton3=(Button)mDialogView.findViewById(R.id.bt_err3);
    ...
    public NiftyDialogBuilder withTitleColor(String colorString) {
        mTitle.setTextColor(Color.parseColor("#99000000"));
        return this;
    }
    ...
    public NiftyDialogBuilder withMessageColor(String colorString) {
        mMessage.setTextColor(Color.parseColor("#99000000"));
        mMessage.setVisibility(View.VISIBLE);
        return this;
    }
